...
export const REGIONEN = [
  {
    ...
    emoji: "🎯",
    farbe: "#7C5CE0",
    kategorien: ["gewohnheiten", "morgenroutine", "abendroutine", "denkpause", "tagesraetsel"],
...
const OHNE_BALKEN = { schlaf: "erholung", atemuebungen: "ruhe", denkpause: "fokus", tagesraetsel: "fokus" };
