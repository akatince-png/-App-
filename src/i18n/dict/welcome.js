...
export const welcome = {
  de: {
    ...
    "welcome.slide1.titel": "Hi, herzlich willkommen bei MyProtocols!",
    "welcome.slide1.text":
      "Schön, dass du dich für uns entschieden hast. Wir helfen dir dabei, Peptide, Medikamente, Supplemente, Gewohnheiten, Schlaf, Hydration, Ernährung und Training an einem Ort zu protokollieren — statt in Notizzetteln und deinem Kopf.",
  ...
  en: {
    "welcome.skip": "Skip",
    "welcome.slide1.titel": "Hi, welcome to MyProtocols!",
    "welcome.slide1.text":
      "We're glad you're here. We help you track peptides, medications, supplements, habits, sleep, hydration, nutrition, and training in one place — instead of scattered notes and your memory.",
